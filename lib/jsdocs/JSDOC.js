...
JSDOC.Symbol.prototype.__defineSetter__("name", function(n) {
...
JSDOC.Symbol.prototype.__defineSetter__("params", function(v) {
    for (var i = 0, l = v.length; i < l; i++) {
        if (v[i].constructor != JSDOC.DocTag) {
 ...
 */
JSDOC.Symbol.prototype.populate = function(name, params, isa, comment) {
    this.$args = arguments;
...
JSDOC.Symbol.prototype.setTags = function() {
    ...
    if (authors.length) this.author = authors.map(function($){ return $.desc; }).join(", ");
