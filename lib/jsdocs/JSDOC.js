...
JSDOC.JsPlate = function(templateFile) {
    if (templateFile) this.template = new String(templateFile.read());
...
// HACK: need to use publisher features
function include(path) {
  return JSDOC.publish.conf.templatesDir.join(path).read().toString();
}
