...
exports.dump = function () {
    if (arguments.length > 1)
        ...
        return _dump(arguments[0]);
    else
        return "()";
};

exports._dump = function (obj) {
        if (typeof obj == 'undefined') return 'undefined';
        var out;
        if (obj.serialize) { return obj.serialize(); }
        var type = exports._typeof(obj);
        ...
        switch (type) {
                ...
                case 'object':
                        ...
                        for (var prop in obj) {
                                if (prop != "circularReference" && obj.hasOwnProperty(prop)) { //hide inherited properties
                                        pairs.push(prop + ': ' + exports._dump(obj[prop]));
                                }
                        }

                        out = '{' + exports._format_list(pairs) + '}';
                        break;
                ...
                case 'array':
                        ...
                        for (var i=0; i<obj.length; i++) {
                                elems.push( exports._dump(obj[i]) );
                        }

                        out = '[' + exports._format_list(elems) + ']';
                        break;
...
exports._format_list = function (list) {
...
exports._dump_dom = function (obj) {
