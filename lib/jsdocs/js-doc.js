...
exports.doc = function doc(options) {
    ...
    var files = getSourceFiles(options.src, options.extensions, exclude, options.recurse);

    var symbols = parseSourceFiles(options, files);
 ...
 */
function parseSourceFiles(options, files) {
