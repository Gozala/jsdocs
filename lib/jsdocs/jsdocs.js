...
var document = exports.document = function(config) {
    ...
    try {
        ...
        else template = packages['JSDocs'].directory.join(defaults.templatePath);
    ...
    _writeFiles(destination, publish(JSDOC.JsDoc.symbolSet, sources, Plugins));
